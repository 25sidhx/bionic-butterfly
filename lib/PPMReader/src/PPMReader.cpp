...
PPMReader *PPMReader::activeInstance = NULL;
...
void PPMReader::isr() {
    if (activeInstance) activeInstance->handlePulse();
}

void PPMReader::handlePulse() {
    // Remember the current micros() and calculate the time since the last pulse
